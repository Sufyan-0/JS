...
// console.log(Object.keys(objArr)) // [ 'name', 'age', 'contactNumber' ]
// console.log(Object.values(objArr)) // [ 'sufyan', 20, 33130 ]

// console.log(Object.entries(objArr)) // [ [ 'name', 'sufyan' ], [ 'age', 20 ], [ 'contactNumber', 33130 ] ]

// console.log(objArr.hasOwnProperty("contactNumber")) // true
...
console.log(objInAr[1].name) // Ahmed