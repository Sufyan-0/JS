...
//  Assume that total marks are 500 for each student, display the scores & percentages of students like :
    // let arrNames = ["Sufyan", "Abdullah", "Rizwan"];
    // let arrNumber = [390, 400, 480];
    // let totalNumber = 500
    // for (let i = 0; i < arrNames.length; ) {
    // for (let j = 0; j < arrNumber.length; ) {
    //     console.log(
    //     `${arrNames[i]} score is ${arrNumber[j]} and percentage is ${
    //         (arrNumber[j] / totalNumber) * 100
    //     }%`
    //     );
    //     i++;
    //     j++;
